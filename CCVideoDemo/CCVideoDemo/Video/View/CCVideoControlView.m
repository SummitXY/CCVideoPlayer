...
- (void)setIsAllControlsShow:(BOOL)isControlViewShow {
     _isAllControlsShow = isControlViewShow;
...
-(void)commonInit {
    ...
    self.controlViewTapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(toggleControlView)];
    self.controlViewPanGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(onPanGestureStateChange:)];
    [self addGestureRecognizer:self.controlViewTapGesture];
    ...
    self.playSlider.backgroundColor = [UIColor redColor];
...
- (void)toggleControlView {
    ...
    self.isAllControlsShow = !self.isAllControlsShow;
}
...
- (void)hideAllControls {
    ...
    self.currentSecondsLabel.hidden = YES;
...
- (void)showAllControls {
    ...
    self.currentSecondsLabel.hidden = NO;
