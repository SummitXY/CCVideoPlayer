...
@property (nonatomic, assign) BOOL isVideoToolViewShow;
    ...
    if ([keyPath isEqualToString:@"status"]) {
        ...
        switch (status) {
            ...
            case AVPlayerItemStatusReadyToPlay:{
                ...
                self.videoControlView.durationLabel.text = [NSString stringFormatterWithSeconds:(int)CMTimeGetSeconds(self.playerItem.duration)];
                self.videoControlView.frame = self.playerLayer.videoRect;
