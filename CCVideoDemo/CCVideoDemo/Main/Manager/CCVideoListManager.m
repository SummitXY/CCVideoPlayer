...
static NSString *const kVideoListUrlString = @"http://mdiscover.cc.163.com/discover/waterfall_list";
...
+ (void)queryVideoListWithParams:(NSDictionary *)params success:(void (^)(NSArray<NSDictionary *> * _Nonnull videoList))success failure:(void (^)(NSError * _Nonnull error))failure {
    ...
    [manager GET:kVideoListUrlString parameters:params progress:^(NSProgress * _Nonnull downloadProgress) {
